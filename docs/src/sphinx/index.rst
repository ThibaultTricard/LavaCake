...
LavaCake come with `GLFW <https://github.com/glfw/glfw>`_. and `ImGui <https://github.com/ocornut/imgui>`_. as submodule.\
This project was originally based onto the `Vulkan CookBook's examples <https://github.com/PacktPublishing/Vulkan-Cookbook>`_. .
